    ...
    constructor() {
        ...
        this.translations = {
            ja: {
                ...
                'ph_restore':                '復元',
                'ph_clear_all':              'すべて削除',
                'tmpl_select_hint':          'テンプレートを選択してください',
                'tmpl_mode_overwrite':       '上書き',
                'tmpl_mode_append':          '追記',
                'tmpl_apply':                '適用',
                'tmpl_history':              '履歴',
                'tmpl_ctx_edit':             '✏️ 編集',
                'tmpl_ctx_thumb':            '🖼️ サムネイルを設定',
                'tmpl_ctx_delete':           '🗑️ 削除',
                'tmpl_modal_add':            'テンプレートを追加',
                'tmpl_modal_edit':           'テンプレートを編集',
                'tmpl_modal_name':           '名前',
                'tmpl_modal_cancel':         'キャンセル',
                'tmpl_modal_save':           '保存',
                'tmpl_confirm_delete':       'このテンプレートを削除しますか？',
                'lib_title_template':        'テンプレート',
                ...
                'btn_update_danbooru_tags':      '🔄 Danbooruタグを最新化',
                'confirm_update_danbooru_tags':  '約14万件のタグ情報をDanbooruから取得します（5〜10分程度かかります）。実行しますか？',
                'confirm_resume_danbooru_update': '前回の更新が {cursor}/{total} 件まで進んだところで中断されています。続きから再開しますか？（キャンセルで最初からやり直します）',
                'label_danbooru_update_progress':'更新中… ({done}/{total})',
                'btn_cancel_danbooru_update':    '中断',
                'toast_danbooru_update_done':    '{updated}件を更新しました（{notFound}件は据え置き）',
                'toast_danbooru_update_aborted': '更新を中断しました（変更は保存されていません）',
                'toast_danbooru_update_error':   'Danbooruタグの更新に失敗しました',
                'toast_danbooru_update_running': '更新は既に実行中です',
                'label_danbooru_last_updated':   '最終更新: {date}',
                'btn_check_danbooru_updates':    '🔍 最新版を確認',
                'label_checking_updates':        '確認中…',
                'label_danbooru_check_uptodate': 'ほぼ最新です（差分 {pct}%）',
                'label_danbooru_check_diff':     'サンプル{sample}件の平均差: {pct}%（例: {examples}）',
                'toast_danbooru_check_error':    '最新版の確認に失敗しました',
            ...
            en: {
                ...
                'tmpl_select_hint':          'Select a template',
                'tmpl_mode_overwrite':       'Overwrite',
                'tmpl_mode_append':          'Append',
                'tmpl_apply':                'Apply',
                'tmpl_history':              'History',
                'tmpl_ctx_edit':             '✏️ Edit',
                'tmpl_ctx_thumb':            '🖼️ Set Thumbnail',
                'tmpl_ctx_delete':           '🗑️ Delete',
                'tmpl_modal_add':            'Add Template',
                'tmpl_modal_edit':           'Edit Template',
                'tmpl_modal_name':           'Name',
                'tmpl_modal_cancel':         'Cancel',
                'tmpl_modal_save':           'Save',
                'tmpl_confirm_delete':       'Delete this template?',
                'lib_title_template':        'Templates',
                ...
                'btn_update_danbooru_tags':      '🔄 Update Danbooru Tags',
                'confirm_update_danbooru_tags':  'This will fetch tag data for ~140,000 tags from Danbooru (takes about 5-10 minutes). Continue?',
                'confirm_resume_danbooru_update': 'The previous update stopped at {cursor}/{total} tags. Resume from there? (Cancel to start over)',
                'label_danbooru_update_progress':'Updating… ({done}/{total})',
                'btn_cancel_danbooru_update':    'Cancel',
                'toast_danbooru_update_done':    'Updated {updated} tags ({notFound} left unchanged)',
                'toast_danbooru_update_aborted': 'Update cancelled (no changes saved)',
                'toast_danbooru_update_error':   'Failed to update Danbooru tags',
                'toast_danbooru_update_running': 'An update is already running',
                'label_danbooru_last_updated':   'Last updated: {date}',
                'btn_check_danbooru_updates':    '🔍 Check for Updates',
                'label_checking_updates':        'Checking…',
                'label_danbooru_check_uptodate': 'Up to date (diff {pct}%)',
                'label_danbooru_check_diff':     'Avg diff over {sample} samples: {pct}% (e.g. {examples})',
                'toast_danbooru_check_error':    'Failed to check for updates',
