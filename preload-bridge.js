...
window.electronAPI = {
  ...
  updateDanbooruTags: (resume) => ipcRenderer.invoke('danbooru:update-tags', { resume }),
  cancelDanbooruUpdate: () => ipcRenderer.invoke('danbooru:update-tags-cancel'),
  onDanbooruUpdateProgress: (cb) => ipcRenderer.on('danbooru:update-progress', (e, data) => cb(data)),
  getDanbooruUpdateResumeState: () => ipcRenderer.invoke('danbooru:update-tags-resume-state'),
  getDanbooruInfo: () => ipcRenderer.invoke('danbooru:get-info'),
  checkDanbooruForUpdates: () => ipcRenderer.invoke('danbooru:check-for-updates'),
